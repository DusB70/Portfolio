 ...
 * - Animated horizontal divider lines that expand on scroll
 * - Staggered paragraph reveals
 * - Subtle opacity and y-translation animations
...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{ y: bgY }}
        className="absolute top-1/2 right-0 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-gradient-radial from-white/[0.02] to-transparent rounded-full blur-3xl translate-x-1/2 -translate-y-1/2 pointer-events-none"
      />
